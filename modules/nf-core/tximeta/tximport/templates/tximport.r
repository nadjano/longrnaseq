...
# txi <- tximport(fns, type = 'oarfish', txOut = TRUE , dropInfReps = dropInfReps)
txi <- tximport(fns, type = 'none', txOut = TRUE, txIdCol = "tname", countsCol = 'num_reads', lengthCol = 'len' , abundanceCol = 'num_reads')
#print(txi)
