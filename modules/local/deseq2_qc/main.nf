process DESEQ2_QC {
    ...
    path "*pca.vals.txt"        , optional:false, emit: pca_txt
    path "*pca.vals_mqc.tsv"    , optional:false, emit: pca_multiqc
    path "*sample.dists.txt"    , optional:false, emit: dists_txt
    path "*sample.dists_mqc.tsv", optional:false, emit: dists_multiqc
