...
**nf-core/plantlongrnaseq** is a bioinformatics pipeline that ...
...
```bash
nextflow run nf-core/plantlongrnaseq \
...
For further information or help, don't hesitate to get in touch on the [Slack `#plantlongrnaseq` channel](https://nfcore.slack.com/channels/plantlongrnaseq) (you can join with [this invite](https://nf-co.re/join/slack)).
